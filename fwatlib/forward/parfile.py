...
# nqdu
# kernel subsampling: samples per period, if NSTEP_PER_FORWARD_OUTPUT =0 , USE kernel_spp to determine one 
NSTEP_PER_FORWARD_OUTPUT        =  0
KERNEL_SPP                      =  8

# min Period of Kernel
KERNEL_T0                       = 5.0
...
INJECTION_TECHNIQUE_TYPE        = 4   # 1 = DSM, 2 = AxiSEM, 3 = FK
...
WAVEFIELD_DISCON_BOX_XMIN       = -120000
WAVEFIELD_DISCON_BOX_XMAX       = 120000
WAVEFIELD_DISCON_BOX_YMIN       = -120000
WAVEFIELD_DISCON_BOX_YMAX       = 120000
WAVEFIELD_DISCON_BOX_ZMIN       = -30000
WAVEFIELD_DISCON_BOX_ZMAX       = 0.

# nqdu wavefield discon options
WAVEFIELD_DISCON_AT_TOP         = .FALSE.
WAVEFIELD_DISCON_EXTRAPOLATION  = .FALSE.
...
def change_parfile(**kargs):
    # load parfile
    lines = _parfile_text().split('\n')
