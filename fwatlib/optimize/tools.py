        ...
        if self._kltype == 1:
            ...
            md_newkl[0,...] = md_kl[0,...]*(2*rho*vp)+md_kl[1,...]*(2*rho*vp)+md_kl[2,...] \
                *(2*rho*vp)+md_kl[6,...]*(2*rho*vp)+md_kl[7,...]*(2*rho*vp)+ \
                md_kl[11,...]*(2*rho*vp)+md_kl[15,...]*(2*rho*vp)+ \
                md_kl[18,...]*(2*rho*vp)
            md_newkl[1,...] = md_kl[1,...]*(-4*rho*vs)+md_kl[2,...]*(-4*rho*vs)+ \
                md_kl[7,...]*(-4*rho*vs)+md_kl[15,...]*(-2*gcp*rho*vs)+ \
                md_kl[16,...]*(-2*gsp*rho*vs)+md_kl[18,...]*(2*gcp*rho*vs)+ \
                md_kl[20,...]*(2*rho*vs)
            md_newkl[2,...] = md_kl[2,...]* (1)+md_kl[0,...]*(vp**2)+md_kl[1,...]*(vp**2 - \
                2*vs**2)+md_kl[2,...]*(vp**2 - 2*vs**2)+md_kl[6,...]*(vp** \
                2)+md_kl[7,...]*(vp**2 - 2*vs**2)+md_kl[11,...]*(vp**2)+ \
                md_kl[15,...]*(-gcp*vs**2 + vp**2)+md_kl[16,...]*(-gsp*vs** \
                2)+md_kl[18,...]*(gcp*vs**2 + vp**2)+md_kl[20,...]*(vs**2)
